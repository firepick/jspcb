(function(exports) {
    ...
    PcbSvgFactory.prototype.pcbBounds = function(options) {
        ...
        bounds.width = Math.abs(bounds.r - bounds.l);
        bounds.height = Math.abs(bounds.b - bounds.t);
        return bounds;
    }
    ...
    PcbSvgFactory.prototype.create = function(writer, options) {
        ...
        that.log('<svg xmlns="http://www.w3.org/2000/svg" version="1.1"',
            ...
            'viewbox="',
            bounds.l, -Math.max(bounds.b, bounds.t), bounds.width, bounds.height,
            '" >');
        ...
        that.writeWires(options.silkWires || [], "silkscreen", colors.silkscreen || "#000");
