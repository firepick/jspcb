...
(function(exports) {
    ...
    PcbTransform.prototype.writePng = function(pngPath, options) {
        ...
        var bufpng = svg2png.sync(bufsvg,pngOptions);
        that.verbose && console.log("Created PNG:"+pngPath, "bytes:"+bufpng.length, "width:"+pngOptions.width);
